...
# I got it in 2696 resets with this code!

# average patch colors of normal and shiny
normal_avg = np.array([217.45454545, 211.10909091, 207.89090909]) # almost white
...
def testShiny(cap):
    ...
    live_avg = avg_patch_color(frame, 826, 518, 830, 528) # target area is chest
...
resetSequence(cap)
ret, frame = cap.read()
cv2.imwrite("azelf/regularAzelf.png", frame)
"""
