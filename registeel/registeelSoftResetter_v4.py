...
numResets = 5940 # current reset counter
# I got it in 528 resets with this code!

# where to save most recent stuff for webserver
stateLocation = "/path/to/shinyHunt/website/state.json"
lastEncounterLocation = "/path/to/shinyHunt/website/last_encounter.jpg"

# average patch colors of normal and shiny
normal_avg = np.array([196.93695652, 196.95869565, 197.13913043]) # light grey
shiny_avg  = np.array([213.07386364, 244.78409091, 175.22727273]) # mint green
...
def testShiny(frame):
    ...
    live_avg = avg_patch_color(frame, 871, 460, 890, 482) # target area is registeel's left side/shoulder
...
resetSequence(cap)
ret, frame = cap.read()
cv2.imwrite("registeel/regularRegisteel.png", frame)
"""
